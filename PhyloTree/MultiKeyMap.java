...
public class MultiKeyMap<V> {
    ...
    // removeAll
    // Pre-conditions:
    // k1 and k2 are two subparts of a key where anykey in the hashmap that
    // contains either k1 or k2 should be removed from said hashmap
    ...
    public java.util.HashMap<String, V> getMap() {
        return this.map;
    } // END getMap()
